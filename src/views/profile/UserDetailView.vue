<template>
	<ProfileLayout title="Customer profile">
		<template #default>
			...
			<p class="fz-5 pt-1"><b>Username:</b> {{ user.username }}</p>
				...
				>
					...
					<div class="fs-5">
						<p>
							...
							This action cannot be undone. Your data, including
							all likes and orders, will be deleted permanently.
						</p>
						<p>
							If you are sure you want to proceed with deleting
